...
**Based on our model, it would appear that gender has the highest effect on 
length of stay (4.51)**
...
**The estimate for the intercept = 3.5**
**The estimate for gender = 4.3**
...
**The standard error of the intercept = 1.0987**
**The standard error of gender = 1.4741**
...
**The results are equal whether we sum the squared residuals or pass 'mod' using the 'deviance' function (= 33.8)**
...
**The results are equal whether we take the square root of the deviance/degrees-of-freedom, or pass 'mod' using the 'deviance' function (= 2.19)**
...
**Our model summary produces a P-value = 0.0224**
**Comparing this to our T-tests - the Welch's test produces a P-value = 0.0221 and the Two-Sample test produces a P-value = 0.0224. The Two-Sample test matches the model summary exactly, while the Welch's is slightly different but still very close.**
